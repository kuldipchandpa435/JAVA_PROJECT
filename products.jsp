...
<a href="<%=request.getContextPath()%>/ProductServlet" class="active">📦 Products</a>
...
<p class="subtitle">Add and manage products.</p>
...
<tr>
<td colspan="4" class="empty-row">No products available.</td>
</tr>
